...
export default function EventBroadcastsPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">配信</h2>
        <Link href={`/events/${id}/broadcasts/new`}>
          <Button>
      ...
      {isLoading ? (
        ...
        <>
          <BroadcastHistoryTable
            ...
            detailHrefPrefix={`/events/${id}/broadcasts`}
          />
